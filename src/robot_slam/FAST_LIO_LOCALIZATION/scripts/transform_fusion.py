...
def transform_fusion():
    ...
    while True:
        ...
        #     T_map_to_base_link = np.matmul(T_map3d_to_odom, T_odom_to_base_link)
        ...
        #     localization.header.frame_id = 'map_3d'
        #     localization.child_frame_id = 'base_link'
        #     # rospy.loginfo_throttle(1, '{}'.format(np.matmul(T_map3d_to_odom, T_odom_to_base_link)))
